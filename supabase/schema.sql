...
-- For math optional (math1-*, math2-*), `quotes` and `static_notes` both store the same JSON:
-- parts (a)–(e) note blobs (dual column so sync survives legacy empty quotes rows).
